...
import 'package:xshop_mobile/services/patch_invoices.dart';

class UpdateInvoices extends StatefulWidget {
  @override
  _UpdateInvoicesState createState() => _UpdateInvoicesState();
}

class _UpdateInvoicesState extends State<UpdateInvoices> {
              ...
              ? Column(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                        onPressed: () {
                          setState(() {
                            _futureInvoices = editInvoices(_idController.text,
